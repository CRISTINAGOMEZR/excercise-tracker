      ...
      <div className="w-full max-w-sm text-center space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm" style={{ color: 'var(--color-muted)' }}>
            Tu biblioteca personal de movimiento
          </p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl text-sm font-medium transition-opacity disabled:opacity-60"
          style={{
