...
export default function TodayPage() {
  ...
  async function handleToggle(ex: Exercise) {
    ...
    if (reg) {
      ...
      setRegistros((prev) => [
        ...prev,
        { id, ejercicioId: ex.id, fecha: ymd(), completadoAt: new Date() },
      ]);
    }
    refreshStats();
  }
  ...
  async function handleToggleRutina(rut: Rutina) {
    ...
    if (reg) {
      ...
      setRegistros((prev) => [
        ...prev,
        { id, rutinaId: rut.id, fecha: ymd(), completadoAt: new Date() },
      ]);
    }
    refreshStats();
  }
  ...
  async function handleLogFree(text: string) {
    ...
    setRegistros((prev) => [
      ...prev,
      { id, actividad: nombre, fecha: ymd(), completadoAt: new Date() },
    ]);
